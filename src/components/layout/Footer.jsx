...
export default function Footer() {
    ...
    return (
        <footer className="bg-neutral-900 text-white py-8">
            {/* Navigation */}
            <div className="container mx-auto flex flex-col md:flex-row md:justify-between items-center gap-6 md:gap-0 px-6 md:px-0">
                <div className="text-2xl font-bold flex">Batikan.</div>
                <div className="flex gap-2 text-xs md:text-sm">
                    <a href="/#" className="px-2.5 md:px-4 py-1 border rounded-full whitespace-nowrap">{t('nav.home')}</a>
                    <a href="/#" className="px-2.5 md:px-4 py-1 border rounded-full whitespace-nowrap">{t('nav.batik')}</a>
                    <a href="/#" className="px-2.5 md:px-4 py-1 border rounded-full whitespace-nowrap">{t('nav.store')}</a>
                    <a href="/#" className="px-2.5 md:px-4 py-1 border rounded-full whitespace-nowrap">{t('nav.ai')}</a>
                    <a href="/#" className="px-2.5 md:px-4 py-1 border rounded-full whitespace-nowrap">{t('nav.contact')}</a>
                </div>
            </div>
